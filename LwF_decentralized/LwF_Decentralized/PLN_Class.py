...
class PLN_network():
    def __init__(self, pln: np.array=None,W_ls: np.array=None,num_layer: int=20, mu=1e3, maxit=30, lamba=1e2):    
    ...
    def construct_one_layer(self, X_train, Y_train, Q):
